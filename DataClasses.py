...
# Sayali, 2022-March-27,Completed TODOs
#------------------------------------------#
...
class Track():
    ...
    def __init__(self,position, title, length):
        """Set position, title, length of a new track Object"""
        #    -- Attributes  -- #
        try:
    ...
    def position(self,position):
        try :
            ...
            print("Value Error , position not integer" ,e)
...
class CD:
    ...
    def get_record(self):
        ...
        return '{} {} {} {} \n'.format(self.cd_id, self.cd_title, self.cd_artist, self.cd_tracks)
    ...
    def rmv_track(self, track_id: int) -> None:
        ...
        if len(self.__cd_tracks) < 1:
            print('No tracks to remove for this Album')
        elif track_id > len(self.__cd_tracks):
            print("Cannot delete as there is no trackID with its lenght greater than the length od cd_tracks")
        else:
